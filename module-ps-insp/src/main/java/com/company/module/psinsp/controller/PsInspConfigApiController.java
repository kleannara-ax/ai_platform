 ...
 * <p>PPM 기준값 및 권한자 ID를 공통코드 테이블(code_group/code_detail)로 관리합니다.
 *
 * <p>권한 체계:
 * <ul>
 *   <li>조회: PS_INSP_MGMT 메뉴 권한</li>
 *   <li>수정: PS_INSP_MGMT 메뉴 권한 + PPM_ADMIN 코드에 등록된 사용자 ID</li>
 * </ul>
 */
@Slf4j
@RestController
...
public class PsInspConfigApiController {
    ...
    /**
     * PPM 기준값 저장 (PPM_ADMIN에 등록된 사용자만 가능)
     ...
     * Body: { "adminIds": ["admin", "inspector01", "user02"] }
     */
    @PreAuthorize("@coreMenuService.hasMenuAccessByAuth(authentication.authorities, 'PS_INSP_MGMT')")
