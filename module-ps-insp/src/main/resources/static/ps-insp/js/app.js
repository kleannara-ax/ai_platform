/**
 * PS 후면 지분 검사 도구 - Application JavaScript v8.7.2
...
(function () {
  ...
  /**
   * PPM 기준값을 서버(DB)에 저장
   * 권한 검증은 서버에서 로그인 사용자 ID 기반으로 수행 (PS_INSP_AUTH 사용자 코드)
  ...
  //
  // 권한 체계:
  //   - PS_INSP_AUTH 사용자 코드에 등록된 사용자만 기준값/권한자 수정 가능
