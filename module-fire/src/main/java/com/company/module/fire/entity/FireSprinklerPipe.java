...
/**
 * 스프링쿨러 배관 엔티티
 * 테이블명: fire_sprinkler_pipe
 */
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Entity
@Table(name = "fire_sprinkler_pipe")
public class FireSprinklerPipe {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "SPRINKLER_PIPE_ID")
    ...
    @Builder
    public FireSprinklerPipe(String serialNumber, String buildingName, Floor floor,
