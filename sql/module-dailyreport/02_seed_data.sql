...
-- ═══════════════════════════════════════════════
INSERT IGNORE INTO core_user (USER_ID, LOGIN_ID, USER_NAME, PASSWORD, EMAIL, DEPARTMENT, POSITION, ROLE, IS_ACTIVE) VALUES
    (1, 'admin', '관리자',           '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'admin@factory.co.kr',   '공장관리부',     '부장', 'ADMIN', 1),
    (2, 'kim',   '김완중 팀장',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'kim@factory.co.kr',     '생산팀',         '팀장', 'USER',  1),
    (3, 'park',  '박지권 책임',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'park@factory.co.kr',    '환경에너지팀',   '책임', 'USER',  1),
    (4, 'yoo',   '유동현 책임',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'yoo@factory.co.kr',     '생산팀',         '책임', 'USER',  1),
    (5, 'jung',  '정상엽 책임',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'jung@factory.co.kr',    '환경팀',         '책임', 'USER',  1),
    (6, 'jang',  '장석환 선임',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'jang@factory.co.kr',    '생산팀',         '선임', 'USER',  1),
    (7, 'lee',   '이도형 사원',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'lee@factory.co.kr',     '생산팀',         '사원', 'USER',  1),
    (8, 'choi',  '최민우 사원',      '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'choi@factory.co.kr',    '환경에너지팀',   '사원', 'USER',  1),
    (9, 'energy','환경에너지팀 반장', '$2a$10$dXJ3SW6G7P50lGmMkkmwe.20cQQubK3.HZWzG3YB1tlRy.fqvM/BG', 'energy@factory.co.kr',  '환경에너지팀',   '반장', 'USER',  1);
...
INSERT INTO daily_report_cell (TABLE_ID, ROW_INDEX, COL_INDEX, EXCEL_COORD, CELL_VALUE, CELL_TYPE, CELL_LABEL, DATA_FORMAT, INPUT_CYCLE, FREQ_CODE, FREQ_LABEL, OWNER_IDS, OWNER_NAMES, IS_LOCKED, ROW_SPAN, COL_SPAN) VALUES
    ...
    (@tbl_1, 4, 13, 'O9', '유동현 책임', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'yoo', '유동현 책임', 0, 1, 1),
    ...
    (@tbl_1, 5, 13, 'O10', '유동현 책임', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'yoo', '유동현 책임', 0, 1, 1),
    ...
    (@tbl_1, 6, 13, 'O11', '유동현 책임', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'yoo', '유동현 책임', 0, 1, 1),
    ...
    (@tbl_1, 8, 3, 'E13', '정상엽 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'jung', '정상엽 책임', 0, 1, 1),
    ...
    (@tbl_1, 8, 13, 'O13', '정상엽 책임', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'jung', '정상엽 책임', 0, 1, 1),
    ...
    (@tbl_1, 9, 3, 'E14', '정상엽 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'jung', '정상엽 책임', 0, 1, 1),
    ...
    (@tbl_1, 9, 13, 'O14', '정상엽 책임', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'jung', '정상엽 책임', 0, 1, 1),
...
INSERT INTO daily_report_cell (TABLE_ID, ROW_INDEX, COL_INDEX, EXCEL_COORD, CELL_VALUE, CELL_TYPE, CELL_LABEL, DATA_FORMAT, INPUT_CYCLE, FREQ_CODE, FREQ_LABEL, OWNER_IDS, OWNER_NAMES, IS_LOCKED, ROW_SPAN, COL_SPAN) VALUES
    ...
    (@tbl_2, 2, 3, 'E21', '김완중 팀장', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'kim', '김완중 팀장', 0, 1, 1),
    ...
    (@tbl_2, 3, 3, 'E22', '김완중 팀장', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'kim', '김완중 팀장', 0, 1, 1),
    ...
    (@tbl_2, 4, 3, 'E23', '김완중 팀장', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'kim', '김완중 팀장', 0, 1, 1),
    ...
    (@tbl_2, 5, 3, 'E24', '김완중 팀장', 'DATA', NULL, NULL, 'DAILY', 'event', '발생 시', 'kim', '김완중 팀장', 0, 1, 1),
    ...
    (@tbl_2, 6, 11, 'M25', '장석환 선임/\n이도형 사원', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'jang lee', '장석환 선임, 이도형 사원', 0, 1, 1),
...
INSERT INTO daily_report_cell (TABLE_ID, ROW_INDEX, COL_INDEX, EXCEL_COORD, CELL_VALUE, CELL_TYPE, CELL_LABEL, DATA_FORMAT, INPUT_CYCLE, FREQ_CODE, FREQ_LABEL, OWNER_IDS, OWNER_NAMES, IS_LOCKED, ROW_SPAN, COL_SPAN) VALUES
    ...
    (@tbl_3, 2, 2, 'D36', '최민우 사원', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'choi', '최민우 사원', 0, 1, 1),
    (@tbl_3, 2, 3, 'E36', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 2, 4, 'F36', '최민우 사원', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'choi', '최민우 사원', 0, 1, 1),
    ...
    (@tbl_3, 3, 2, 'D37', '최민우 사원', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'choi', '최민우 사원', 0, 1, 1),
    (@tbl_3, 3, 3, 'E37', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 3, 4, 'F37', '최민우 사원', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'choi', '최민우 사원', 0, 1, 1),
    ...
    (@tbl_3, 4, 2, 'D38', '최민우 사원', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'choi', '최민우 사원', 0, 1, 1),
    (@tbl_3, 4, 3, 'E38', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 4, 4, 'F38', '최민우 사원', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'choi', '최민우 사원', 0, 1, 1),
    ...
    (@tbl_3, 5, 2, 'D39', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_3, 5, 3, 'E39', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 5, 4, 'F39', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_3, 6, 2, 'D40', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_3, 6, 3, 'E40', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 6, 4, 'F40', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_3, 7, 2, 'D41', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_3, 7, 3, 'E41', 'EIS', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_3, 7, 4, 'F41', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
...
INSERT INTO daily_report_cell (TABLE_ID, ROW_INDEX, COL_INDEX, EXCEL_COORD, CELL_VALUE, CELL_TYPE, CELL_LABEL, DATA_FORMAT, INPUT_CYCLE, FREQ_CODE, FREQ_LABEL, OWNER_IDS, OWNER_NAMES, IS_LOCKED, ROW_SPAN, COL_SPAN) VALUES
    ...
    (@tbl_4, 2, 1, 'K36', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 2, 2, 'L36', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_4, 2, 5, 'O36', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 2, 6, 'P36', '환경에너지팀 반장', 'DATA', NULL, NULL, 'DAILY', 'daily', '매일', 'energy', '환경에너지팀 반장', 0, 1, 1),
    ...
    (@tbl_4, 3, 1, 'K37', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 3, 2, 'L37', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_4, 3, 5, 'O37', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 3, 6, 'P37', '환경에너지팀 반장', 'DATA', NULL, NULL, 'DAILY', 'daily', '매일', 'energy', '환경에너지팀 반장', 0, 1, 1),
    (@tbl_4, 4, 0, 'J38', '복합보일러', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_4, 4, 1, 'K38', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 4, 2, 'L38', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_4, 4, 5, 'O38', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 4, 6, 'P38', '환경에너지팀 반장', 'DATA', NULL, NULL, 'DAILY', 'daily', '매일', 'energy', '환경에너지팀 반장', 0, 1, 1),
    (@tbl_4, 5, 0, 'J39', '폐합성소각로', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_4, 5, 1, 'K39', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 5, 2, 'L39', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_4, 5, 5, 'O39', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 5, 6, 'P39', '환경에너지팀 반장', 'DATA', NULL, NULL, 'DAILY', 'daily', '매일', 'energy', '환경에너지팀 반장', 0, 1, 1),
    (@tbl_4, 6, 0, 'J40', '합  계', 'READONLY', NULL, NULL, 'NONE', NULL, NULL, NULL, NULL, 1, 1, 1),
    (@tbl_4, 6, 1, 'K40', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 6, 2, 'L40', '박지권 책임', 'DATA', NULL, NULL, 'YEARLY', 'yearly', '매년', 'park', '박지권 책임', 0, 1, 1),
    ...
    (@tbl_4, 6, 5, 'O40', '박지권 책임', 'DATA', NULL, NULL, 'MONTHLY', 'monthly', '매월', 'park', '박지권 책임', 0, 1, 1),
    (@tbl_4, 6, 6, 'P40', '환경에너지팀 반장', 'DATA', NULL, NULL, 'DAILY', 'daily', '매일', 'energy', '환경에너지팀 반장', 0, 1, 1);
