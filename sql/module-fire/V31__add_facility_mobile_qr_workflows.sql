...
SELECT COUNT(*) INTO @has_water_photo_path
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_SCHEMA = DATABASE()
  AND TABLE_NAME = 'facility_water_disinfection'
  AND COLUMN_NAME = 'PHOTO_PATH';
SET @sql := IF(@has_water_photo_path > 0,
    'ALTER TABLE facility_water_disinfection MODIFY COLUMN PHOTO_PATH VARCHAR(600) NULL',
    'SELECT 1'
);
PREPARE stmt FROM @sql;
EXECUTE stmt;
