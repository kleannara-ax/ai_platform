-- ============================================================
-- module-ps-insp: 권한자 관리를 PS_INSP_AUTH 코드그룹으로 분리
-- 기존: PS_INSP_DEFAULT(또는 PS_INSP_CONFIG) > PPM_ADMIN
-- 변경: PS_INSP_AUTH > PPM_ADMIN (extraValue1에 콤마 구분 ID)
--
-- 기존에 배포된 운영 환경에서 실행 (02_config_schema.sql 이후)
-- ============================================================

-- 1) PS_INSP_AUTH 코드 그룹 생성
...
WHERE g.GROUP_CODE IN ('PS_INSP_DEFAULT', 'PS_INSP_CONFIG', 'PS_INSP_PPM_LIMIT', 'PS_INSP_ADMIN')
