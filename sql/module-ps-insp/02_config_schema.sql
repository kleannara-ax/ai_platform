...
VALUES ('PS_INSP_PPM_LIMIT', 'PS 지분검사 PPM 기준값', 'PS 후면 지분 검사 모듈 PPM 기준값 설정 (기준값, 권한자 관리)', 1, 100)
...
FROM code_group g WHERE g.GROUP_CODE = 'PS_INSP_PPM_LIMIT'
...
WHERE g.GROUP_CODE = 'PS_INSP_PPM_LIMIT' AND d.CODE = 'ADMIN_PWD_HASH';
