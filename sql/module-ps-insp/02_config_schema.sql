...
VALUES ('PS_INSP_CONFIG', 'PS 지분 검사 설정', 'PS 후면 지분 검사 모듈 설정 (PPM 기준값, 권한자 관리 등)', 1, 100)
...
FROM code_group g WHERE g.GROUP_CODE = 'PS_INSP_CONFIG'
...
WHERE g.GROUP_CODE = 'PS_INSP_CONFIG' AND d.CODE = 'ADMIN_PWD_HASH';
