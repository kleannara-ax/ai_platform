...
--  더 이상 독립 메뉴가 아니다(과거 SAFETY_UPLOAD 메뉴는 제거됨).
...
-- 페이지 (parent = SAFETY_MGMT) — 분류/매뉴얼 목록 1개뿐 (엑셀 업로드는 이 화면의 모달)
INSERT INTO core_menu (MENU_CODE, MENU_NAME, PARENT_ID, MENU_URL, ICON, MENU_TYPE, SORT_ORDER, IS_VISIBLE, IS_ACTIVE, CREATED_AT)
...
INSERT INTO core_role_menu (ROLE, MENU_ID) SELECT 'ROLE_USER', MENU_ID FROM core_menu WHERE MENU_CODE LIKE 'SAFETY_%';
