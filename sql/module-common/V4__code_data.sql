...
-- ── 4. 부서 목록 (공통코드로 관리) ──
INSERT INTO MOD_CODE_GROUP (GROUP_CODE, GROUP_NAME, DESCRIPTION, IS_ACTIVE, SORT_ORDER) VALUES
('DEPT', '부서', '부서 목록 (공통코드로 관리)', 1, 4);

SET @g4 = LAST_INSERT_ID();
INSERT INTO MOD_CODE_DETAIL (GROUP_ID, CODE, CODE_NAME, DESCRIPTION, IS_ACTIVE, SORT_ORDER) VALUES
(@g4, 'HQ',    '본사',         NULL,                    1, 1),
...
INSERT INTO MOD_CODE_DETAIL (GROUP_ID, CODE, CODE_NAME, DESCRIPTION, EXTRA_VALUE1, IS_ACTIVE, SORT_ORDER) VALUES
