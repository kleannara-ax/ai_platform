...
2. 소방설비는 기존 소화기/소화전/수신기/펌프 메뉴에서 관리합니다.
3. 기타설비는 에어컨/정수기 메뉴에서 관리합니다.
4. 목록에서 설비 행을 클릭하면 상세 정보와 점검 이력을 볼 수 있습니다.
5. 권한이 있는 사용자는 추가/수정/삭제/점검 및 이미지 업로드를 수행할 수 있습니다.
6. 등록/수정 화면에서 도면을 클릭해 X/Y 좌표를 선택할 수 있습니다.
