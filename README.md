...
- **Main Features**:
  ...
  - 소방설비 대시보드: 점검필요 비율, 이상설비 수, 정상/점검필요/교체필요 그래프, 이상설비 도면 바로가기
...
2. 소방설비 대시보드에서 설비 유형별 점검필요 비율, 이상설비 수, 상태 그래프를 확인합니다.
3. 대시보드 하단 이상설비 목록의 `바로가기`를 누르면 층별 도면 또는 메인 도면에서 해당 마커가 선택됩니다.
